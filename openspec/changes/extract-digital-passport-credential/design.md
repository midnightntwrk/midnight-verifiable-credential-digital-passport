...
- Which RC version number core chooses for `midnight-did-credentials` — **not yet published** (see Spike Outcome 1.1); this repo will pin whatever ships once the RC exists.
