...
#
# Vendored copy of the Midnight circuit-parameter derivation from the
# `midnight-verifiable-credentials` monorepo
# (`nix/packages/midnight-circuit-params.nix` at blob 382a8784, develop).
# Since that repository's Compact 0.31.1 migration
# (midnightntwrk/midnight-verifiable-credentials#432), no upstream flake
# exports `midnight-circuit-params`, so this repository vendors the
# derivation to keep offline compact compilation self-contained. The
# derivation body below is a byte-copy of the upstream file; only this
