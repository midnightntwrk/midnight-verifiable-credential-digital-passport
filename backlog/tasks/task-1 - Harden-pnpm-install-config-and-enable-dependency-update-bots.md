...
- AC2: pnpm-workspace.yaml sets blockExoticSubdeps: true, minimumReleaseAge: 10080, trustPolicy: no-downgrade, minimumReleaseAgeExclude: [], trustPolicyExclude: []. Confirmed pnpm 10.34.1 parses them: 'pnpm config get' returned true / 10080 / no-downgrade / [] / []. Negative test: trustPolicy: bogus-value makes install fail with a config error (settings are validated, not silently ignored).
