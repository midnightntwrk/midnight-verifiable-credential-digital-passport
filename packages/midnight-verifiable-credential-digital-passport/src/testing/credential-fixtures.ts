...
const deriveProofChallenge = (bodyRoot: Uint8Array, proof: Proof, context: ProofContext): bigint =>
  context === 'issuance'
...
export const createDigitalPassportFixtureWithoutDocumentNumber = (): DigitalPassportFixture =>
  buildDigitalPassportFixture(
    createSigner('issuer', 123456789n),
    createSigner('holder', 987654321n),
...
): DigitalPassportFixture => buildDigitalPassportFixture(issuer, holder, verifierChallengeHash);

export const createDigitalPassportProtocolFixture = (): DigitalPassportProtocolFixture => {
...
export const createDigitalPassportProtocolFixtureForParticipants = (
  ...
  createDigitalPassportProtocolFixtureFromFixture(
    createDigitalPassportFixtureForParticipants(issuer, holder, verifierChallengeHash),
  );
...
const createDigitalPassportProtocolFixtureFromFixture = (
  ...
  const verificationRequest: DigitalPassportVerificationRequest = {
    ...
    body: {
      requireFirstNameDisclosure: fixture.presentationRequest.requireFirstNameDisclosure,
      requireLastNameDisclosure: fixture.presentationRequest.requireLastNameDisclosure,
      requireAgeOverThreshold: fixture.presentationRequest.requireAgeOverThreshold,
      requestedAgeThresholdYears: fixture.presentationRequest.requestedAgeThresholdYears,
      requireDocumentNumberDisclosure: fixture.presentationRequest.requireDocumentNumberDisclosure,
      requireIssuingStateDisclosure: fixture.presentationRequest.requireIssuingStateDisclosure,
    },
  };
  ...
  const verificationResult: DigitalPassportVerificationResult = {
    ...
    approved: true,
    body: {
      credentialRoot: pureCircuits.digitalPassportCredentialBodyRoot(fixture.credential),
